...
LPCSTR pedModelData[740][2] = {
	...
	{ "ig_claypain", "Clay Jackson" },
	{ "cs_clay", "Clay Simons(CS)" },
	{ "ig_clay", "Clay Simons)" },
	{ "csb_cletus", "Cletus(CS?)" },
	{ "ig_cletus", "Cletus" },
	{ "cs_dale", "Dale(CS)" },
	{ "ig_dale", "Dale" },
	{ "cs_davenorton", "Dave Norton(CS)" },
	...
	{ "ig_popov", "Dima Popov" },
	{ "cs_dom", "Dom Beasley(CS)" },
	{ "ig_dom", "Dom Beasley" },
	{ "cs_drfriedlander", "Dr.Friedlander(CS)" },
	{ "ig_drfriedlander", "Dr.Friedlander" },
	{ "u_m_m_edtoh", "Eddie Toh" },
	{ "cs_tomepsilon", "Epsilon Tom(CS)" },
	{ "ig_tomepsilon", "Epsilon Tom" },
	{ "cs_fabien", "Fabien(CS)" },
	{ "ig_fabien", "Fabien" },
	{ "cs_mrk", "Ferdinand Kerimov(CS)" },
	{ "ig_mrk", "Ferdinand Kerimov" },
	{ "cs_floyd", "Floyd Hebert(CS)" },
	...
	{ "cs_jimmyboston", "Jimmy Boston(CS)" },
	{ "ig_jimmyboston", "Jimmy Boston" },
	{ "cs_jimmydisanto", "Jimmy De Santa(CS)" },
	{ "ig_jimmydisanto", "Jimmy De Santa" },
	{ "mp_m_marston_01", "John Marston" },
	{ "cs_johnnyklebitz", "Johnny Klebitz(CS)" },
	{ "ig_johnnyklebitz", "Johnny Klebitz" },
	{ "cs_joeminuteman", "Joe(CS)" },
	{ "ig_joeminuteman", "Joe" },
	{ "cs_josef", "Josef(CS)" },
	{ "ig_josef", "Josef" },
	{ "cs_josh", "Josh(CS)" },
	{ "ig_josh", "Josh" },
	{ "u_m_y_justin", "Justin" },
	{ "cs_karen_daniels", "Karen Daniels(CS)" },
	{ "ig_karen_daniels", "Karen Daniels" },
	{ "ig_kerrymcintosh", "Kerry McIntosh" },
	{ "cs_lamardavis", "Lamar Davis(CS)" },
	{ "ig_lamardavis", "Lamar Davis" },
	{ "cs_lazlow", "Lazlow(CS)" },
	{ "ig_lazlow", "Lazlow" },
	{ "cs_lestercrest", "Lester Crest(CS)" },
	{ "ig_lestercrest", "Lester Crest" },
	{ "cs_magenta", "Magenta(CS)" },
	{ "ig_magenta", "Magenta" },
	{ "cs_manuel", "Manuel(CS)" },
	{ "ig_manuel", "Manuel" },
	{ "u_m_m_markfost", "Mark Fostenburg" },
	{ "cs_marnie", "Marnie Allen(CS)" },
	{ "ig_marnie", "Marnie Allen" },
	{ "cs_martinmadrazo", "Martin Madrazo(CS)" },
	{ "cs_maryann", "Mary-Ann Quinn(CS)" },
	{ "ig_maryann", "Mary-Ann Quinn" },
	{ "csb_maude", "Maude" },
	{ "ig_maude", "Maude" },
	{ "cs_michelle", "Michelle(CS)" },
	{ "ig_michelle", "Michelle" },
	{ "cs_milton", "Milton McIlroy(CS)" },
	{ "ig_milton", "Milton McIlroy" },
	{ "u_f_m_miranda", "Miranda" },
	{ "mp_f_misty_01", "Misty" },
	{ "cs_molly", "Molly(CS)" },
	{ "ig_molly", "Molly" },
	{ "cs_mrsphillips", "Mrs.Phillips(CS)" },
	{ "ig_mrsphillips", "Mrs.Phillips" },
	{ "cs_mrs_thornhill", "Mrs.Thornhill(CS)" },
	{ "ig_mrs_thornhill", "Mrs.Thornhill" },
	{ "cs_natalia", "Natalia(CS)" },
	{ "ig_natalia", "Natalia" },
	{ "cs_nervousron", "Nervous Ron(CS)" },
	...
	{ "cs_patricia", "Patricia(CS)" },
	{ "ig_patricia", "Patricia" },
	{ "cs_dreyfuss", "Peter Dreyfuss(CS)" },
	{ "ig_dreyfuss", "Peter Dreyfuss" },
	{ "u_m_y_pogo_01", "Pogo the Monkey" },
	{ "u_f_y_poppymich", "Poppy Mitchell" },
	{ "csb_rashcosvki", "Rashkovsky(CS)" },
	{ "ig_rashcosvki", "Rashkovsky" },
	{ "csb_roccopelosi", "Rocco Pelosi" },
	{ "ig_roccopelosi", "Rocco Pelosi" },
	{ "cs_siemonyetarian", "Simeon Yetarian(CS)" },
	{ "ig_siemonyetarian", "Simeon Yetarian" },
	{ "cs_solomon", "Solomon Richards(CS)" },
	{ "ig_solomon", "Solomon Richards" },
	{ "cs_stevehains", "Steve Haines(CS)" },
	{ "ig_stevehains", "Steve Haines" },
	{ "cs_stretch", "Stretch(CS)" },
	{ "ig_stretch", "Stretch" },
	{ "ig_talina", "Talina" },
	{ "cs_tanisha", "Tanisha(CS)" },
	{ "ig_tanisha", "Tanisha" },
	{ "cs_taocheng", "Tao Cheng(CS)" },
	{ "ig_taocheng", "Tao Cheng" },
	{ "cs_taostranslator", "Tao's Translator (CS)" },
	...
	{ "csb_tonya", "Tonya" },
	{ "ig_tonya", "Tonya" },
	{ "cs_tracydisanto", "Tracey De Santa(CS)" },
	{ "ig_tracydisanto", "Tracey De Santa" },
	{ "ig_tylerdix", "Tyler Dixon" },
	{ "cs_wade", "Wade(CS)" },
	{ "ig_wade", "Wade" },
	{ "cs_chengsr", "Wei Cheng(CS)" },
	{ "ig_chengsr", "Wei Cheng" },
	{ "cs_zimbor", "Zimbor(CS)" },
	{ "ig_zimbor", "Zimbor" },
	{ "csb_agent", "Agent(CS)" },
	{ "ig_agent", "Agent" },
	{ "csb_mp_agent14", "Agent 14(CS)" },
	...
	{ "mp_s_m_armoured_01", "Armored Van Security(MP)" },
	{ "s_m_m_armoured_01", "Armored Van Security" },
	{ "s_m_m_armoured_02", "Armored Van Security 2" },
	...
	{ "ig_bestmen", "Best Man" },
	{ "a_f_m_bevhills_01", "Bev Hills Female" },
	{ "a_f_m_bevhills_02", "Bev Hills Female 2" },
	{ "a_m_m_bevhills_01", "Bev Hills Male" },
	{ "a_m_m_bevhills_02", "Bev Hills Male 2" },
	{ "a_f_y_bevhills_01", "Bev Hills Young Female" },
	{ "a_f_y_bevhills_02", "Bev Hills Young Female 2" },
	{ "a_f_y_bevhills_03", "Bev Hills Young Female 3" },
	{ "a_f_y_bevhills_04", "Bev Hills Young Female 4" },
	{ "a_m_y_bevhills_01", "Bev Hills Young Male" },
	{ "a_m_y_bevhills_02", "Bev Hills Young Male 2" },
	{ "cs_orleans", "Bigfoot(CS)" },
	{ "ig_orleans", "Bigfoot" },
	...
	{ "csb_bride", "Bride(CS?)" },
	{ "ig_bride", "Bride" },
	{ "csb_burgerdrug", "Burger Drug Worker(CS?)" },
	...
	{ "csb_car3guy1", "Car 3 Guy 1(CS)" },
	{ "ig_car3guy1", "Car 3 Guy 1" },
	{ "csb_car3guy2", "Car 3 Guy 2(CS)" },
	{ "ig_car3guy2", "Car 3 Guy 2" },
	{ "cs_carbuyer", "Car Buyer(CS)" },
	...
	{ "cs_chrisformage", "Cris Formage(CS)" },
	...
	{ "a_m_m_genfat_01", "G Fat Male" },
	{ "a_m_m_genfat_02", "G Fat Male 2" },
	{ "a_f_y_genhot_01", "G Hot Young Female" },
	{ "a_f_o_genstreet_01", "G Street Old Female" },
	{ "a_m_o_genstreet_01", "G Street Old Male" },
	{ "a_m_y_genstreet_01", "G Street Young Male" },
	{ "a_m_y_genstreet_02", "G Street Young Male 2" },
	...
	{ "csb_groom", "Groom(CS?)" },
	{ "ig_groom", "Groom" },
	{ "csb_grove_str_dlr", "Grove Street Dealer(CS?)" },
	...
	{ "u_m_o_taphillbilly", "Jesco White" },
	...
	{ "u_f_y_jewelass_01", "Jeweler Assistant" },
	{ "cs_jewelass", "Jeweler Assistant(CS)" },
	{ "ig_jewelass", "Jeweler Assistant" },
	{ "u_m_m_jewelsec_01", "Jeweler Security" },
	...
	{ "cs_lifeinvad_01", "Life Invader(CS)" },
	...
	{ "a_m_m_mexlabor_01", "Mexican Laborer" },
	...
	{ "cs_movpremf_01", "Movie Premiere Female(CS)" },
	{ "s_m_m_movprem_01", "Movie Premiere Male" },
	{ "cs_movpremmale", "Movie Premiere Male(CS)" },
	{ "u_f_o_moviestar", "Movie Star Female" },
	{ "a_m_m_og_boss_01", "OG Boss" },
	{ "cs_old_man1a", "Old Man 1 (CS)" },
	{ "ig_old_man1a", "Old Man 1" },
	{ "cs_old_man2", "Old Man 2 (CS)" },
	...
	{ "a_f_m_prolhost_01", "Prologue Female" },
	{ "a_m_m_prolhost_01", "Prologue Male" },
	{ "u_f_o_prolhost_01", "Prologue Old Female" },
	...
	{ "cs_prolsec_02", "Prologue Security 2 (CS)" },
	...
	{ "a_f_y_rurmeth_01", "Rural Methhead Female" },
	{ "a_m_m_rurmeth_01", "Rural Methhead Male" },
	{ "cs_russiandrunk", "Russian Drunk(CS)" },
	...
	{ "s_f_y_shop_mid", "Sales Assistant(Mid-Range)" },
	...
	{ "a_f_m_soucent_01", "S Central Female" },
	{ "a_f_m_soucent_02", "S Central Female 2" },
	{ "a_m_m_socenlat_01", "S Central Latino Male" },
	{ "a_m_m_soucent_01", "S Central Male" },
	{ "a_m_m_soucent_02", "S Central Male 2" },
	{ "a_m_m_soucent_03", "S Central Male 3" },
	{ "a_m_m_soucent_04", "S Central Male 4" },
	{ "a_f_m_soucentmc_01", "S Central MC Female" },
	{ "a_f_o_soucent_01", "S Central Old Female" },
	{ "a_f_o_soucent_02", "S Central Old Female 2" },
	{ "a_m_o_soucent_01", "S Central Old Male" },
	{ "a_m_o_soucent_02", "S Central Old Male 2" },
	{ "a_m_o_soucent_03", "S Central Old Male 3" },
	{ "a_f_y_soucent_01", "S Central Young Female" },
	{ "a_f_y_soucent_02", "S Central Young Female 2" },
	{ "a_f_y_soucent_03", "S Central Young Female 3" },
	{ "a_m_y_soucent_01", "S Central Young Male" },
	{ "a_m_y_soucent_02", "S Central Young Male 2" },
	{ "a_m_y_soucent_03", "S Central Young Male 3" },
	{ "a_m_y_soucent_04", "S Central Young Male 4" },
	...
	{ "cs_tenniscoach", "Tennis Coach(CS)" },
